      ...
      <div className="font-sans">
        ...
        <nav className="mx-auto px-6 md:px-16 sm:px-24 flex justify-between items-center py-4 lg:py-0 bg-white shadow-md">
          ...
          <div className="block flex items-center gap-5">
            ...
            <button onClick={() => router.push('/login')} className="bg-[#005944] hover:bg-green-800 text-white font-semibold px-4 py-2 sm:px-6 sm:py-2 md:px-6 md:py-2 text-sm sm:text-base md:text-lg rounded-lg shadow-lg">
              Login
            </button>
          </div>
